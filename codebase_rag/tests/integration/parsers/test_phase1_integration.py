...
from codebase_rag.parsers.core.lazy_parser_factory import LazyParserFactory
from codebase_rag.parsers.core.query_cache import QueryCache
...
class TestBackwardCompatibility:
    ...
    def test_parsers_module_imports(self):
        ...
        from codebase_rag.parsers.core import factory
        from codebase_rag.parsers.pipeline import call_processor, definition_processor
