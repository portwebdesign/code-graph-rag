...
class AppConfig(BaseSettings):
    ...
    MCP_ENFORCE_COMPLEX_PLAN_GATE: bool = False
    MCP_ENFORCE_MEMORY_PRIMING_GATE: bool = False
    MCP_ENABLE_PHASE_GATES: bool = False
    MCP_ENABLE_VISIBILITY_GATES: bool = False
    MCP_ENABLE_PROMPTS: bool = False
    MCP_ENABLE_RESOURCES: bool = False
    MCP_ENABLE_ANALYSIS_BUNDLES: bool = False
