...
class AppConfig(BaseSettings):
    ...
    CODEGRAPH_GIT_DELTA: bool = False
    CODEGRAPH_SELECTIVE_UPDATE: bool = False
    CODEGRAPH_INCREMENTAL_CACHE: bool = False
    CODEGRAPH_WRITE_ANALYSIS_GRAPH_NODES: bool = False

    AGENT_RETRIES: int = 3
    AGENT_MAX_STEPS: int = 6
    ORCHESTRATOR_OUTPUT_RETRIES: int = 100
    MCP_AGENT_TIMEOUT_SECONDS: int = 300
    MCP_PLAN_TASK_TIMEOUT_SECONDS: int = 3

    MCP_SYNC_GRAPH_TIMEOUT_SECONDS: int = 120
    MCP_ORCHESTRATE_RETRY_BASE_DELAY_SECONDS: float = 0.05
    MCP_ORCHESTRATE_SYNC_RETRY_ATTEMPTS: int = 1
    MCP_ORCHESTRATE_VALIDATE_RETRY_ATTEMPTS: int = 1
    MCP_ORCHESTRATE_AUTO_NEXT_RETRY_ATTEMPTS: int = 1
    ...
    MCP_ENFORCE_GRAPH_FIRST_READS: bool = False
    MCP_READ_FILE_REQUIRES_QUERY_GRAPH: bool = False
    MCP_REQUIRE_SESSION_PREFLIGHT: bool = False
    MCP_REQUIRE_PROJECT_NAME_PARAM: bool = True
    MCP_PREFLIGHT_SCHEMA_SUMMARY_LIMIT: int = 450
    MCP_PREFLIGHT_SCHEMA_PREVIEW_ROWS: int = 20
    MCP_SCHEMA_CONTEXT_MAX_RELATIONS: int = 25
    MCP_AUTO_PLAN_ON_FIRST_QUERY: bool = False
    MCP_ENFORCE_COMPLEX_PLAN_GATE: bool = True
    MCP_ENFORCE_MEMORY_PRIMING_GATE: bool = False
    MCP_ENABLE_PHASE_GATES: bool = False
    MCP_ENABLE_VISIBILITY_GATES: bool = True
    MCP_ENABLE_PROMPTS: bool = True
    MCP_ENABLE_RESOURCES: bool = True
    MCP_ENABLE_ANALYSIS_BUNDLES: bool = True
    MCP_TOOLSET: str = "extended"
    ...
    MCP_HTTP_RATE_LIMIT_WINDOW_SECONDS: int = 60
    MCP_HTTP_RATE_LIMIT_MAX_REQUESTS: int = 120
    MCP_HTTP_AUDIT_LOG_ENABLED: bool = True
