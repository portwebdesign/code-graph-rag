...
class AnalysisRunnerProtocol(Protocol):
    ...
    def _normalize_dead_code_path(self, path: str | None) -> str: ...

    def _is_runtime_source_path(self, path: str) -> bool: ...

    def _is_generated_or_noise_path(self, path: str) -> bool: ...

    def _is_test_dead_code_item(self, path: str, name: str) -> bool: ...

    def _language_from_path(self, path: str) -> str: ...

    def _should_skip_duplicate_path(self, path: str) -> bool: ...

    def _should_skip_static_analysis_path(self, path: str) -> bool: ...

    def _is_likely_ignored_variable(self, name: str) -> bool: ...

    def _is_control_transfer_line(self, line: str) -> bool: ...

    def _next_executable_line(
        self, lines: list[str], start_idx: int
    ) -> tuple[int | None, str | None]: ...

    def _leading_indent(self, line: str) -> int: ...
