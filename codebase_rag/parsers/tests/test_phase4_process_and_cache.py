...
from codebase_rag.parsers.process_manager import (
    ParserJobInfo,
    ParserJobStatus,
...
class TestPhase4Integration:
    ...
    def test_backward_compatibility(self):
        ...
        from codebase_rag.parsers.framework_detectors import PythonFrameworkDetector
        from codebase_rag.parsers.query_engine import QueryEngine
        from codebase_rag.parsers.ruby.ruby_parser import RubyParserMixin
