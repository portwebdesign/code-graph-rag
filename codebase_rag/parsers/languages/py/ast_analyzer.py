...
from codebase_rag.parsers.core.utils import normalize_query_captures, safe_decode_text
...
class PythonAstAnalyzerMixin(_AstBase):
    ...
    def _find_python_method_in_ast(
        ...
        for class_node in captures.get(cs.QUERY_CAPTURE_CLASS, []):
            ...
            method_captures = normalize_query_captures(
                method_cursor.captures(body_node)
            )
